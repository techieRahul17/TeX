...
class Wallpapers {
  static const List<WallpaperOption> options = [
    ...
    WallpaperOption(
      ...
      colors: [Color(0xFF150000), Color(0xFF400505)], // Visible Crimson Gradient
      accentColor: Color(0xFFFF1744), 
      bubbleColor: Color(0xFFD50000),
    ...
    WallpaperOption(
      id: 'electric_noir',
      name: 'Electric Noir',
      colors: [Color(0xFF020215), Color(0xFF0A1045)], // Visible Deep Blue Gradient
    ...
    WallpaperOption(
      id: 'cute_paws',
      name: 'Cute Paws',
      colors: [Color(0xFF250510), Color(0xFF450A20)], // Visible Dark Pink
    ...
    WallpaperOption(
      id: 'galactic_stars',
      name: 'Galactic Stars',
      colors: [Color(0xFF050525), Color(0xFF101050)], // Space Blue
      accentColor: Color(0xFFFFD700),
      bubbleColor: Color(0xFF00BFFF),
    ...
    WallpaperOption(
      id: 'cyber_city',
      name: 'Cyber City',
      colors: [Color(0xFF001515), Color(0xFF003030)], // Cyber Cyan Gradient
      accentColor: Color(0xFF00FFFF),
      bubbleColor: Color(0xFF00AAAA),
      pattern: WallpaperPattern.geometry,
    ),
    
    // 5. Classic Void (Charcoal/Black)
    WallpaperOption(
      id: 'classic_void',
      name: 'Classic Void',
      colors: [Color(0xFF121212), Color(0xFF252525)], // Visible Grey Gradient
    ...
    WallpaperOption(
      ...
      colors: [Color(0xFF150525), Color(0xFF301045)], // Visible Deep Purple
